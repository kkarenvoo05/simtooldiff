...
# python scripts/eval_diffusion_policy.py \
#   --checkpoint /move/u/karenvo/Projects/diffusion_policy/data/outputs/2026.05.20/12.36.07_train_diffusion_unet_hybrid_simtool_image_state29/checkpoints/epoch=0020-val_loss=0.0404.ckpt \
#   --split ood \
#   --episodes-per-object 32 \
#   --num-envs 8 \
#   --output-json data/diffusion_eval/epoch0020_pickup_ood_eval_5x_incomplete.json
